...
<div class="container-fluid px-0">
    <div class="mb-4">
        ...
        <p class="text-muted mb-0">Perbarui informasi barang inventaris</p>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-select @error('kategori') is-invalid @enderror" name="kategori" required>
                            ...
                            <option value="Jaringan" {{ old('kategori', $barang->kategori) == 'Jaringan' ? 'selected' : '' }}>Jaringan</option>
                            <option value="Multimedia" {{ old('kategori', $barang->kategori) == 'Multimedia' ? 'selected' : '' }}>Multimedia</option>
                            <option value="Alat Praktik" {{ old('kategori', $barang->kategori) == 'Alat Praktik' ? 'selected' : '' }}>Alat Praktik</option>
                        </select>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="number" class="form-control @error('jumlah') is-invalid @enderror" 
                               name="jumlah" value="{{ old('jumlah', $barang->jumlah) }}" min="1" required>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="date" class="form-control @error('tanggal_input') is-invalid @enderror" 
                               name="tanggal_input" value="{{ old('tanggal_input', $barang->tanggal_input) }}" required>
